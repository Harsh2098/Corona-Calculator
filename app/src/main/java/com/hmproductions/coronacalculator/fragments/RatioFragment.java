...
public class RatioFragment extends Fragment {
    ...
    private GetGraphDetails graphDetails;
    ...
    public void onAttach(Context context) {
        ...
        try {
            graphDetails = (GetGraphDetails) context;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) customView.findViewById(R.id.xAxisLabelTextView)).setText(R.string.height_spacing);
